...
|---|---|---|---|---|---|---|
| **mediapipe** | MediaPipe BlazeFace (TFLite CPU) | `img_1.png` | 1 | `(425, 413, 235, 235)` | 0.9527 | 43.36 ms |
| **mediapipe** | MediaPipe BlazeFace (TFLite CPU) | `img_2.jpg` | 1 | `(627, 762, 286, 286)` | 0.9214 | 42.8 ms |
| **mediapipe** | MediaPipe BlazeFace (TFLite CPU) | `img_3.jpg` | 1 | `(199, 316, 592, 592)` | 0.9545 | 20.17 ms |
| **retinaface** | InsightFace SCRFD / det_10g (ONNX Runtime) | `img_1.png` | 1 | `(430, 359, 246, 304)` | 0.7472 | 503.43 ms |
| **retinaface** | InsightFace SCRFD / det_10g (ONNX Runtime) | `img_2.jpg` | 1 | `(635, 681, 264, 361)` | 0.8765 | 579.69 ms |
| **retinaface** | InsightFace SCRFD / det_10g (ONNX Runtime) | `img_3.jpg` | 1 | `(240, 185, 483, 683)` | 0.8756 | 296.44 ms |
| **yolov8** | YOLOv8-Face / yolov8n-face (Ultralytics PyTorch) | `img_1.png` | 1 | `(434, 352, 247, 317)` | 0.8552 | 4135.44 ms |
| **yolov8** | YOLOv8-Face / yolov8n-face (Ultralytics PyTorch) | `img_2.jpg` | 1 | `(633, 681, 265, 360)` | 0.8966 | 398.41 ms |
| **yolov8** | YOLOv8-Face / yolov8n-face (Ultralytics PyTorch) | `img_3.jpg` | 1 | `(242, 177, 483, 697)` | 0.8581 | 359.43 ms |
...
|---|---|---|---|---|
| **arcface** | 512-D | 1.0 | 2415.49 ms | Additive Angular Margin Loss (Chuẩn hiện đại, phân tách góc cao) |
| **facenet512** | 512-D | 1.0 | 3643.33 ms | Triplet Loss (Khoảng cách Euclidean/Cosine) |
| **sface** | 128-D | 1.0 | 499.78 ms | SphereFace variant (Tối ưu nhẹ cho Edge CPU) |
...
|---|---|---|---|---|
| **arcface** | **0.4281** | 0.1021 | **+0.3260** | **[0.11 - 0.42]** (Độ chính xác 100%) |
| **facenet512** | **0.5562** | 0.0745 | **+0.4817** | **[0.08 - 0.55]** (Độ chính xác 100%) |
